#!/usr/bin/env python3
"""
MOTU M4 Dynamic Optimizer - System Tray Application (PyQt5)
...
STATE_FILE = os.environ.get("TRAY_STATE_FILE", "/var/run/motu-m4-tray-state")
ICON_DIR = os.environ.get("TRAY_ICON_DIR", "/usr/share/icons/motu-m4")
...
class MotuM4Tray(QSystemTrayIcon):
    """System tray icon for MOTU M4 Dynamic Optimizer."""
    ...
    def check_motu_connected(self) -> bool:
        """Check if MOTU M4 is connected via ALSA or USB."""
...
def main():
    ...
    app.setApplicationName("MOTU M4 Optimizer")
    app.setApplicationDisplayName("MOTU M4 Optimizer")
    app.setDesktopFileName("motu-m4-tray")
